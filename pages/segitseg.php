...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="segitseg">
            <p>Bátran kérhetsz segítséget a <span>szüleidtől</span>.</p>
            <div class="socials">
                <div class="fb">
                    <a href="#"><img src="../assets/media/icons/fb.png" alt=""></a>
                </div>
                <div class="ig">
                    <a href="#"><img src="../assets/media/icons/ig.png" alt=""></a>
                </div>
                <div class="discord">
                    <a href="#"><img src="../assets/media/icons/discord.png" alt=""></a>
                </div>
            </div>
        </div>
    </div>
