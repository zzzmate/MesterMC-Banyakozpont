...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="news">
            <div class="news-info">
                <p style="margin-bottom: 20px;">Kedves, <span><?php echo htmlspecialchars($username)?></span></p>
                <p>Real street nigga, I ain't tryna feel no sorrow (no)</p>
                <p>Drive that Maybach like a fuckin' Monte Carlo</p>
                <p>I been tryna find some peace and only God know (yeah)</p>
                <p><span>Cross me once, can't call my phone, you get the dial tone</span></p>
            </div>
        </div>
    </div>
</body>
